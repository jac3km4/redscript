...
fn compile_base_class_overload() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::Local(PoolIndex::new(32)),
        Instr::InvokeStatic(Offset::new(26), 0, PoolIndex::new(28), 3),
        Instr::I32Const(1),
        Instr::I32Const(2),
        Instr::ParamEnd,
        Instr::Nop,
...
fn compile_basic_casts() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::InvokeStatic(Offset::new(21), 0, PoolIndex::new(22), 3),
        Instr::I32Const(1),
        Instr::ParamEnd,
        Instr::Assign,
        Instr::Local(PoolIndex::new(27)),
        Instr::InvokeStatic(Offset::new(21), 0, PoolIndex::new(23), 3),
        Instr::I32Const(2),
        Instr::ParamEnd,
        Instr::Nop,
    ];
...
fn compile_overloaded_call() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::InvokeStatic(Offset::new(35), 0, PoolIndex::new(22), 3),
        Instr::RefToWeakRef,
        Instr::Local(PoolIndex::new(38)),
        Instr::Local(PoolIndex::new(38)),
        Instr::ParamEnd,
...
fn compile_for_loop() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::InvokeStatic(Offset::new(43), 0, PoolIndex::new(24), 3),
        Instr::Local(PoolIndex::new(34)),
        ...
        Instr::Local(PoolIndex::new(33)),
        Instr::Local(PoolIndex::new(34)),
        Instr::InvokeStatic(Offset::new(34), 0, PoolIndex::new(22), 3),
        Instr::ToString(PoolIndex::new(8)),
        Instr::Local(PoolIndex::new(30)),
        Instr::ParamEnd,
        Instr::InvokeStatic(Offset::new(30), 0, PoolIndex::new(23), 3),
        Instr::Local(PoolIndex::new(34)),
        Instr::I32Const(1),
        Instr::ParamEnd,
...
fn compile_implicit_conversions() -> Result<(), Error> {
    let sources = r#"
        ...
        "#;
    let expected = vec![
        Instr::InvokeStatic(Offset::new(30), 0, PoolIndex::new(22), 3),
        ...
        Instr::RefToWeakRef,
        Instr::New(PoolIndex::new(25)),
        Instr::InvokeStatic(Offset::new(26), 0, PoolIndex::new(23), 3),
        Instr::WeakRefToRef,
        Instr::Local(PoolIndex::new(31)),
        Instr::ParamEnd,
        Instr::Nop,
...
fn compile_ternary_op() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::InvokeStatic(Offset::new(51), 0, PoolIndex::new(23), 3),
        Instr::InvokeStatic(Offset::new(30), 0, PoolIndex::new(22), 3),
...
fn compile_method_overload_call() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::This,
        Instr::InvokeStatic(Offset::new(16), 0, PoolIndex::new(26), 3),
        Instr::ParamEnd,
        Instr::Nop,
    ];
    check_function_bytecode(sources, expected)
