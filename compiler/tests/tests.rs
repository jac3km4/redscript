...
fn compile_base_class_overload() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::Local(PoolIndex::new(32)),
        Instr::InvokeStatic(Offset::new(24), 0, PoolIndex::new(28), 0),
        Instr::I32Const(1),
        Instr::I32Const(2),
        Instr::ParamEnd,
        Instr::Nop,
...
fn compile_basic_casts() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::InvokeStatic(Offset::new(19), 0, PoolIndex::new(22), 0),
        Instr::I32Const(1),
        Instr::ParamEnd,
        Instr::Assign,
        Instr::Local(PoolIndex::new(27)),
        Instr::InvokeStatic(Offset::new(19), 0, PoolIndex::new(23), 0),
        Instr::I32Const(2),
        Instr::ParamEnd,
        Instr::Nop,
    ];
...
fn compile_overloaded_call() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::InvokeStatic(Offset::new(33), 0, PoolIndex::new(22), 0),
        Instr::RefToWeakRef,
        Instr::Local(PoolIndex::new(38)),
        Instr::Local(PoolIndex::new(38)),
        Instr::ParamEnd,
...
fn compile_for_loop() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::InvokeStatic(Offset::new(41), 0, PoolIndex::new(24), 0),
        Instr::Local(PoolIndex::new(34)),
        ...
        Instr::Local(PoolIndex::new(33)),
        Instr::Local(PoolIndex::new(34)),
        Instr::InvokeStatic(Offset::new(32), 0, PoolIndex::new(22), 0),
        Instr::ToString(PoolIndex::new(8)),
        Instr::Local(PoolIndex::new(30)),
        Instr::ParamEnd,
        Instr::InvokeStatic(Offset::new(28), 0, PoolIndex::new(23), 0),
        Instr::Local(PoolIndex::new(34)),
        Instr::I32Const(1),
        Instr::ParamEnd,
...
fn compile_switch_case() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::InvokeStatic(Offset::new(28), 0, PoolIndex::new(22), 0),
...
fn compile_ternary_op() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::InvokeStatic(Offset::new(47), 0, PoolIndex::new(23), 0),
        Instr::InvokeStatic(Offset::new(28), 0, PoolIndex::new(22), 0),
...
fn compile_method_overload_call() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::This,
        Instr::InvokeStatic(Offset::new(14), 0, PoolIndex::new(26), 0),
        Instr::ParamEnd,
        Instr::Nop,
    ];
    check_function_bytecode(sources, expected)
